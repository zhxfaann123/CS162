...
int main() {
  ...
  // These two commented print statements therefore cause UNDEFINED BEHAVIOR
  // which is very very bad
  // To remedy this, the preferred solution would be to make a copy in the constructor
  // of string_pair_create
  // Or to create a "method" (like string_pair_do_stuff) that acts on a string_pair_t's fields
